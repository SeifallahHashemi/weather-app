    ...
    return(
        <div className="calculator">
            <div className="calculator__output">
                <div className="calculator__output--previous">{formatOperand(calculatorState.previousOperand)} {calculatorState.operation}</div>
                <div className="calculator__output--current">{formatOperand(calculatorState.currentOperand)}</div>
            </div>
            <DigitButton dispatch={dispatch}/>
        </div>
    )
};
